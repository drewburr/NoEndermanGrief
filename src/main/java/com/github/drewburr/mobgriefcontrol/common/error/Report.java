...
public class Report {
	...
	public static class ReportBuilder {
		 ...
		 * @param rateLimit - number of nanoseconds, or 0 to disable. Cannot be mobgriefcontrolative.
		 * @return This builder, for chaining.
		 */
		 ...
		 * @param rateLimit - the time, or 0 to disable. Cannot be mobgriefcontrolative.
	 ...
	 * @return The number of nanoseconds. Never mobgriefcontrolative.
	 */
