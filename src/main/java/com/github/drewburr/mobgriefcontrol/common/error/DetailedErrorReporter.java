package com.github.drewburr.mobgriefcontrol.common.error;
...
import com.github.drewburr.mobgriefcontrol.common.collections.ExpireHashMap;
import com.github.drewburr.mobgriefcontrol.common.error.Report.ReportBuilder;
...
public class DetailedErrorReporter implements ErrorReporter {
	...
	public DetailedErrorReporter(Plugin plugin, String prefix, String supportURL, int maxErrorCount, Logger logger) {
		...
		this.logger = logger;
		this.plugin = (MobGriefControl) plugin;
	}
	...
	public void reportDetailed(Object sender, Report report) {
		...
		// And plugin
		if (plugin != null) {
			writer.println("Version: " + this.plugin.getName() + " v" + this.plugin.getPluginMeta().getVersion());
			String jarfilename = this.plugin.getjarfilename();
